package com.example.wbs.utils.constants;

public class Constants {

    public static final String SOMETHING_WENT_WRONG = "Terjadi kesalahan";
    ...
    public static final String KEY_PREF_ROLE = "pref_role";
    public static final String KEY_PREF_IS_LOGIN = "pref_is_login";
